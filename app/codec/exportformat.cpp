...
#include "olive/core/render/audioparams.h"  // Include the header for AudioParams
...
QList<int> ExportFormat::GetSampleRatesForCodec(Format format, ExportCodec::Codec codec) {
  QList<int> sample_rates;

  // Use the supported sample rates from AudioParams
  for (int rate : olive::core::AudioParams::kSupportedSampleRates) {
